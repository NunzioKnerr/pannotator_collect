...
# For example, set metresBetweenEachImageWanted <- 1 to extract images a minimum of 1 metre apart.
...
# if it doesn't exist then throw up a dialog to select the overlay
